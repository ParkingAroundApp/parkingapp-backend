...
public class FabricUtils {
	public static void enrollAdmin() throws Exception {
		...
		HFCAClient caClient = HFCAClient.createNewInstance(config.getOrganizationInfo("Org1").getCertificateAuthorities().get(0));
		...
		// Create a wallet for managing identities
		  ...
		  boolean adminExists = wallet.exists("admin"); if (adminExists) { System.out.
